          ...
          <ul class="navbar-nav align-items-center">
            ...
            <li class="nav-item dropdown dropdown-user-setting">
              ...
              <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li>
                  <a class="dropdown-item" href="designer_profile.php">
                    <div class="d-flex align-items-center">
                      <div class="">
                        <ion-icon name="person-outline"></ion-icon>
                      </div>
                ...
                <li>
                  <a class="dropdown-item" href="C:\xampp\htdocs\archi\dashmin_panel\designer_profile.php">
                    <div class="d-flex align-items-center">
                      <div class="">
                ...
                <li>
                  <a class="dropdown-item" href="designer_logout.php">
                    <div class="d-flex align-items-center">
                      <div class="">
